...
export default function EditExerciseModal() {
  ...
  const [weightUnit, setWeightUnit] = useState<WeightUnit>(
    exercise?.metrics?.weightUnit || "kg"
  );
  const [duration, setDuration] = useState<DurationMetrics>(
    exercise?.metrics?.duration || initialDuration
  );
  ...
  useEffect(() => {
    if (!exercise && routineId && exerciseId) {
      ...
      setWeightUnit(exercise.metrics?.weightUnit || "kg");
      setDuration(exercise.metrics?.duration || initialDuration);
